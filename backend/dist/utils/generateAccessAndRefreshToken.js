...
var generateAccessAndRefreshToken = function (userId) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 5:
                error_1 = _a.sent();
                throw new apiError_1.default("Something went wrong: ".concat(error_1.message), 500);
