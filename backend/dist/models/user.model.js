    ...
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (!process.env.ACCESS_TOKEN_SECRET) {
                throw new apiError_1.default('ACCESS_TOKEN_SECRET is not defined in the environment', 500);
            }
...
userSchema.methods.generateRefreshToken = function () {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            return [2 /*return*/, jsonwebtoken_1.default.sign({ _id: this._id }, process.env.REFRESH_TOKEN_SECRET, {
